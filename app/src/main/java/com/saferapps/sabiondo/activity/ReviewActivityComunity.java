...
public class ReviewActivityComunity extends AppCompatActivity {

    public MaterialCardView cardView_A, cardView_B, cardView_C, cardView_D,playagain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reviews = FragmentComunityQuiz.reviewscq;
