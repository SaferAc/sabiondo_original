...
public class CircularProgressIndicator2 extends View {
    ...
    private static final String DEFAULT_PROGRESS_COLOR = "#00AEAE";
    private static final int DEFAULT_TEXT_SIZE_SP = 24;
    private static final int DEFAULT_STROKE_WIDTH_DP = 10;
    private static final String DEFAULT_PROGRESS_BACKGROUND_COLOR = "#FFFFFF";
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        int textColor = Color.parseColor(DEFAULT_PROGRESS_BACKGROUND_COLOR);
    ...
    public void SetAttributes(int progressColor, int dotColor, int progressBackgroundColor, int textSize) {
